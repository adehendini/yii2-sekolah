...
/**
 * CariKelas represents the model behind the search form about `backend\models\Kelas`.
 */
class CariKelas extends Kelas
{
    public $wali_kelas;
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'kelas', $this->kelas])
            ->andFilterWhere(['like', 'concat(guru.nama,guru.nuptk)', $this->wali_kelas]);
